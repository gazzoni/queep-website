      ...
      <div className="relative mx-auto w-full max-w-5xl pt-32 pb-20 px-4">
        <div className="text-center">
          ...
          <div className={`relative mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ animationDelay: "0.4s" }}>
            <Button className="flex items-center gap-2 rounded-lg bg-brand-green px-8 py-4 text-white hover:bg-[#004020] transition-all shadow-lg hover:shadow-xl text-base font-medium">
              <svg
                width="18"
                height="18"
                viewBox="0 0 20 26"
            ...
            <Button className="flex items-center gap-2 rounded-lg bg-white border-2 border-brand-text/10 px-8 py-4 text-brand-text hover:bg-brand-gray transition-all shadow-lg hover:shadow-xl text-base font-medium">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 25"
